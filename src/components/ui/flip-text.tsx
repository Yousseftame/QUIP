...
interface FlipTextProps {
    ...
    /**
     * Only animate when the parent element is hovered
     * @default false
     */
...
export function FlipText({
    ...
    const shouldLoop = animateOnHover ? false : loop;
    ...
    return (
        <div
            className={cn(
                ...
                animateOnHover && "flip-text-on-hover",
                !animateOnHover && !shouldLoop && "flip-text-once",
                className
            )}
                                    ...
                                    style={
                                        {
                                            ...
                                            "--flip-iteration": shouldLoop ? "infinite" : "1",
